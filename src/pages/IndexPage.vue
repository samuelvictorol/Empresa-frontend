<template>
  <q-page class="relative  landing-page" style="padding-top: 2rem;">
    ...
    <div class="page-inner q-px-md q-py-lg">
      ...
      <div class="w100 row justify-center q-pa-lg">
        <header id="top" class="landing-header glass-card row items-center justify-between w90 q-mb-xl" style="position: fixed;">
          ...
          <nav class="gt-sm row items-center">
            ...
            <q-btn unelevated no-caps class="q-ml-sm cta-btn" icon="mdi-whatsapp" label="Agendar consultoria gratuita"
              @click="openWhatsapp" />
          </nav>
      ...
      <q-slide-transition  style="position: fixed;z-index: 99999;" class="w90">
        <div v-if="drawerOpen" class="lt-md glass-card q-pa-sm q-mb-lg nav-mobile">
          <q-btn v-for="item in navItems" :key="item.target" flat dense no-caps
            class="full-width text-left text-dark q-mb-xs" :label="item.label" @click="scrollToSection(item.target)" />
          <q-btn unelevated no-caps class="full-width q-mt-sm cta-btn" icon="mdi-whatsapp" label="Agendar consultoria"
            @click="openWhatsapp" />
        </div>
      </q-slide-transition>
      ...
      <!-- MARCAS + CARROSSEL -->
      <section id="marcas" class="section-block q-mb-md animate__animated animate__slower animate__delay-1s animate__zoomInDown">
      ...
      <!-- COMO FUNCIONA -->
      <section id="como-funciona" class="section-block q-mb-xl animate__animated animate__slower animate__delay-1s animate__fadeInRight">
        ...
        <div class="row items-center justify-between q-col-gutter-md">
          <div class="col-12 col-md-auto">
            <div class="text-caption">
              {{ companyName }} — Consultoria em Nuvem, Automação e IA no WhatsApp.
            </div>
            <div class="text-caption">
              Atendemos Valparaíso de Goiás, região do DF, Goiânia e projetos remotos em todo o Brasil.
            </div>
          </div>
    ...
    <!-- BOTÃO FIXO IA -->
    <q-btn round  class="ia-fab cta-btn animate__animated animate__slower animate__delay-4s animate__fadeInUp" @click="openIAChat()">
